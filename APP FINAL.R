...
rsconnect::setAccountInfo(name='dariusskw',
                          token='E1789F64B33324827B4C1678646823E5',
                          secret='K94hkZLrHRjqNtKMcxNOHcT3OOaAsCHvNrfozNJf')
library(rsconnect)
rsconnect::deployApp('APP FINAL.R')
